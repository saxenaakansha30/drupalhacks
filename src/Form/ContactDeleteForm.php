...
/**
 * Provides a form for deleting a drupalhacks_contact entity.
 *
 * @ingroup drupalhacks
 */
class ContactDeleteForm extends ContentEntityConfirmFormBase {
  ...
  {
    return new Url('entity.drupalhacks_contact.collection');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.drupalhacks_contact.collection');
  }
}
?>
